...
-   Meeting with Jim, Paul, Cecilia and Mark notes:
    ...
    -   My notes:
        ...
        -   Attend Plan Team meeting next week for Cole's presentation about the RE model (I did, and this is the relevant presentation slides and associated paper)
...
-   I worked on streamlining and cleaning up my RE code, and while doing this ran into an issue with compile_admb(), where it was giving me an error saying that it couldn't find the re.tpl file at the file path I provided
