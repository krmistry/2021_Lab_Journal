...
-   Now that the RE model is working, my next steps are:
    ...
    -   Clean up RE code, put it in in its own script and push to github (this week)

    -   Do RE model runs for the rest of the subregions for POP and all subregions for NR (this week)
